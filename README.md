...
You can find web app via API code in [*main_api.py*](https://github.com/AslauAlexandru/Week-1-Headstarter-Accelerator-Project-1-Customer-Churn-Prediction-with-Machine-Learning/blob/main/main_api.py) and other code with ```app = FastAPI()```. You can try this code, but replace with your URL:
```python
